    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">智能简历精修</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 智能简历精修与大厂润色</span>
...
// 清理回复末尾的特殊标记 [JIANLI_SCORES]...[/JIANLI_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[JIANLI_SCORES\][\s\S]*?\[\/JIANLI_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 智能简历精修】\n\n${cleanContent.value}\n\n体验大厂STAR简历润色大模型：https://ai.wuxian.xyz`;
